              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {events.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-400 mb-4">No events have been collected yet.</p>
                    <p className="text-sm text-gray-500">Go to the "Live Engine" tab to run analysis and collect data.</p>
                  </div>
                ) : (
                  events.map((event) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {correlations.length === 0 ? (
              <div className="col-span-2 text-center py-8">
                ...
                <p className="text-gray-400 mb-4">No correlations have been detected yet.</p>
                <p className="text-sm text-gray-500">Run the Live Correlation Engine to find correlations between events.</p>
              </div>
            ) : (
